...
// Dynamically import Gallery for consistency
...
// Reviews will now be fetched from Supabase (homepage testimonials)
...
export default function WeddingDecorClientPage() {
    ...
    useEffect(() => {
        const fetchReviews = async () => {
            ...
            if (!error && data && data.length > 0) {
                ...
                setReviews(uniqueReviews.slice(0, 8)); // Show up to 8 unique testimonials
            }
        };
        fetchReviews();
    }, []);
    ...
    return (
        <div className="bg-white overflow-x-hidden">
            ...
            {/* 7. TESTIMONIALS - High-End Slider */}
