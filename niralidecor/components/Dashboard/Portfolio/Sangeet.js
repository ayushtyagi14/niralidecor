...
const Sangeet = () => {
    ...
    const uploadFile = async () => {
        ...
        formData.append('path', 'assets/portfolio/sangeet-garba');
    ...
    const handleDelete = async () => {
        ...
        try {
            ...
            const { data, error } = await Supabase
                ...
                .eq('page', 'sangeet-garba'); // Ensure only the relevant entry is deleted
    ...
    return (
        <div className='flex flex-col items-start w-full'>
            <div className="p-6 space-y-4">
                <h2 className="text-2xl font-bold">Sangeet & Garba Page Banner</h2>
                {mediaUrl ? (
                    <div>
            ...
            <div className="p-6 space-y-4">
                <h2 className="text-2xl font-bold">Sangeet & Garba Page Gallery</h2>
