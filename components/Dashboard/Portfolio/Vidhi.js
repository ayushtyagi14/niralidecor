...
const Vidhi = () => {
    ...
    const uploadFile = async () => {
        ...
        formData.append('path', 'assets/portfolio/vidhi-haldi');
    ...
    const handleDelete = async () => {
        ...
        try {
            ...
            const { data, error } = await supabase
                ...
                .eq('page', 'vidhi-haldi'); // Ensure only the relevant entry is deleted
    ...
    return (
        <div className='flex flex-col items-start w-full'>
            <div className="p-6 space-y-4">
                <h2 className="text-2xl font-bold">Vidhi & Haldi Page Banner</h2>
                {mediaUrl ? (
                    <div>
            ...
            <div className="p-6 space-y-4">
                <h2 className="text-2xl font-bold">Vidhi & Haldi Page Gallery</h2>
