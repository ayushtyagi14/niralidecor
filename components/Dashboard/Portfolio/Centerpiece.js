...
const Centerpiece = () => {
    ...
    const uploadFile = async () => {
        ...
        formData.append('path', 'assets/portfolio/centerpiece');
    ...
    const handleDelete = async () => {
        ...
        try {
            ...
            const { data, error } = await Supabase
                ...
                .eq('page', 'centerpiece'); // Ensure only the relevant entry is deleted
    ...
    return (
        <div className='flex flex-col items-start w-full'>
            <div className="p-6 space-y-4">
                <h2 className="text-2xl font-bold">Centerpiece Page Banner</h2>
                {mediaUrl ? (
                    <div>
            ...
            <div className="p-6 space-y-4">
                <h2 className="text-2xl font-bold">Centerpiece Page Gallery</h2>
