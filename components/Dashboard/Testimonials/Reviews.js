...
const Reviews = () => {
    ...
    const handleFileUpload = async (id) => {
        ...
        formData.append('path', `assets/testimonials/reviews`);
    ...
    const handleAddReview = async () => {
        ...
        try {
            ...
            const { error } = await Supabase
                .from('Reviews')
                .insert([{ page: 'testimonials', mediaUrl, name, review }]);
    ...
    const deleteMedia = async () => {
        ...
        try {
            ...
            const { data, error } = await Supabase
                ...
                .eq('page', 'testimonials'); // Ensure you are updating the correct entry
    ...
    return (
        <div className="p-6 space-y-4">
            <h2 className="text-2xl font-bold">Testimonials Page Reviews</h2>
