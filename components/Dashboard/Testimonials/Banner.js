...
const Banner = () => {
    ...
    const uploadFile = async () => {
        ...
        formData.append('path', 'assets/testimonials/banner');
    ...
    const deleteBanner = async () => {
        ...
        try {
            ...
            const { data, error } = await supabase
                ...
                .eq('page', 'testimonials'); // Ensure only the relevant entry is deleted
    ...
    return (
        <div className="p-6 space-y-4">
            <h2 className="text-2xl font-bold">Testimonials Page Banner</h2>
            {mediaUrl ? (
                <div>
