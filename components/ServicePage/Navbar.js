...
const Navbar = () => {
    ...
    return (
        <nav className="fixed w-full z-50 transition-all duration-300">
            <div
                className={`bg-[#f4c7ffca] text-[#96034f] mx-auto lg:px-28 px-5 transition-all duration-300`}
            >
            ...
            >
                <div className={`flex flex-col items-center space-y-4 py-4 bg-[#f4c7ffca] w-[90%] mx-auto my-2 rounded-[50px] shadow-lg uppercase tracking-widest text-[#96034f]`}>
                    <Link href="/">
